...
public class RiskResult {
    ...
    public String getZScoreFormulaVersion() {
        return zScoreFormulaVersion;
    }

    public void setZScoreFormulaVersion(String zScoreFormulaVersion) {
        this.zScoreFormulaVersion = zScoreFormulaVersion;
    }
}
